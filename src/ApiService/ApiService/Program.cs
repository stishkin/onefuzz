    ...
    public static async Async.Task Main() {
        using var host =
            ...
            .ConfigureServices((context, services) => {
                ...
                .AddSingleton<IAutoScaleOperations, AutoScaleOperations>()
                ...
                .AddSingleton<ITaskEventOperations, TaskEventOperations>()
                .AddSingleton<IQueue, Queue>()
                .AddSingleton<IProxyOperations, ProxyOperations>()
                .AddSingleton<IProxyForwardOperations, ProxyForwardOperations>()
                .AddSingleton<IConfigOperations, ConfigOperations>()
                .AddSingleton<IScalesetOperations, ScalesetOperations>()
                .AddSingleton<IContainers, Containers>()
                .AddSingleton<IReports, Reports>()
                .AddSingleton<INotificationOperations, NotificationOperations>()
                .AddSingleton<IUserCredentials, UserCredentials>()
                .AddSingleton<IReproOperations, ReproOperations>()
                .AddSingleton<IPoolOperations, PoolOperations>()
                .AddSingleton<IIpOperations, IpOperations>()
                .AddSingleton<IDiskOperations, DiskOperations>()
                .AddSingleton<IVmOperations, VmOperations>()
                .AddSingleton<ISecretsOperations, SecretsOperations>()
                .AddSingleton<IJobOperations, JobOperations>()
                .AddSingleton<INsgOperations, NsgOperations>()
                .AddSingleton<IScheduler, Scheduler>()
                .AddSingleton<IConfig, Config>()
                .AddSingleton<ILogAnalytics, LogAnalytics>()
                .AddSingleton<IExtensions, Extensions>()
                .AddSingleton<IVmssOperations, VmssOperations>()
                .AddSingleton<INodeTasksOperations, NodeTasksOperations>()
                .AddSingleton<INodeMessageOperations, NodeMessageOperations>()
                .AddSingleton<IRequestHandling, RequestHandling>()
                .AddSingleton<IImageOperations, ImageOperations>()
                .AddSingleton<IOnefuzzContext, OnefuzzContext>()
                .AddSingleton<IEndpointAuthorization, EndpointAuthorization>()
                .AddSingleton<INodeMessageOperations, NodeMessageOperations>()
                .AddSingleton<ISubnet, Subnet>()
                .AddSingleton<IAutoScaleOperations, AutoScaleOperations>()
